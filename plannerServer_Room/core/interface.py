...
# ## Room
x_start = np.array([0,1.0,0.8,0,0])  # Starting node
object_center = [0,1.2,1.0]
r0 = 1.0;step_size = 0.6
pos = [[-0.5,1.3,0.6],[-0.5,1.0,0.8],[-0.5,1.0,1.0],[-0.5,1.0,1.2],[-0.5,1.0,1.4]]
...
def our_planner():
    ...
    if view_num < view_maxnum:
        if first_Flag[0]:
            ...
            # nbv_final = np.array([-0.5,         1.7,         0.3,         1.21833705,  4.56958931,  1.        ])
