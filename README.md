...
- May 24, 2024: the paper and video for **[Autonomous Implicit Indoor Scene Reconstruction with Frontier Exploration (ICRA 2024)](https://small-zeng.github.io/AIISRFE/)** are released! It supports autonomous implicit reconstruction of larger indoor scenes and is more efficient. The code is released. check [this link](https://github.com/small-zeng/AIISRFE).
